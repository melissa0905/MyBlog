...
<body>
	...
	<cfobject name="filmmodel" type="component" component="calismalar.BenVeProjem.models.Film">
	<cfset Filmdata = filmmodel.getlist(attributes.Adi)>
					...
					<div class="menu_nav">
						<div id="nav-wrap">
							<ul class="arrowunderline" id="nav">
								...
								<li class="Films" id="selected"><a href="Films.cfm">Films</a></li>
			       ...
			       <div class="table-title">
						<div class="row">
							...
							<div class="col-sm-6">
								...
								<p><h2>Filmler ve <b>Ozellikleri</b></h2></p>
									<table class="table">
  									  <thead>
      									  <tr>
        							  		<th>
											<a href="film_add.cfm" ><h3>Film_Ekle</h3></a> 
											</th>
       								  		<th>
										     <a href="film_upd.cfm" ><h3>Film_Guncelle</h3></a>
											</th>        											  
											<th>
										     <a href="film_delete.cfm" ><h3>Film_Sil</h3></a>
											</th>        											  
								    ...
								    <cfquery name="query_list" datasource="workCubeDSN">
     								  ...
     								  <cfoutput query="Filmdata">
            							<tr>
										 ...
										 <td>#OyuncuAdi#</td>
               							 <td>
                    						<a href="/Films.cfm?fuseaction=film&event=upd&id=#Id#"><i class="fa fa-pencil"></i></a>
                						</td>
            							</tr>
        							  </cfoutput>
    	     						</tbody>

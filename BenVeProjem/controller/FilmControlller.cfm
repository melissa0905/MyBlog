...
if(attributes.tabMenuController eq 0)
	{
		...
		WOStruct['#attributes.fuseaction#']['list']['filePath'] = 'calismalar/BenVeProjem/film_list.cfm';
		...
		WOStruct['#attributes.fuseaction#']['add']['filePath'] = 'calismalar/BenVeProjem/film_list.cfm';
		WOStruct['#attributes.fuseaction#']['add']['queryPath'] = 'calismalar/BenVeProjem/action/filmadd.cfm';
		...
		WOStruct['#attributes.fuseaction#']['upd']['filePath'] = 'calismalar/BenVeProjem/film_upd.cfm';
		WOStruct['#attributes.fuseaction#']['upd']['queryPath'] = 'calismalar/BenVeProjem/actions/filmupd.cfm';

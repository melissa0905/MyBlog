...
<body>
	...
	<cfobject name="bookmodel" type="component" component="calismalar.BenVeProjem.models.Book">
	<cfset Bookdata = bookmodel.getlist(attributes.adi)>
					...
					<div class="menu_nav">
						<div id="nav-wrap">
							<ul class="arrowunderline" id="nav">
								...
								<li class="books" id="selected"><a href="Books.cfm">Books</a></li>
						...
						<div class="row">
						   <div class="col-sm-6">
							...
							<div class="col-sm-6">
								...
								<p><h2>Kitaplar ve <b>Ozellikleri</b></h2></p>
									<table class="table">
  									  <thead>
      									  <tr>
        							  		<th>
											<a href="kitap_add.cfm" ><h3>Kitap_Ekle</h3></a> 
											</th>
       								  		<th>
										     <a href="kitap_upd.cfm" ><h3>Kitap_Guncelle</h3></a>
											</th>        											  
												  
										     <th>
										     <a href="kitap_delete.cfm" ><h3>Kitap_Sil</h3></a>
											</th>        											  

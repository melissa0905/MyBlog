...
<body>
	...
	<cfobject name="oyuncumodel" type="component" component="calismalar.BenVeProjem.models.Actor">
	<cfset Oyuncudata = oyuncumodel.getlist(attributes.adi)>
					...
					<div class="menu_nav">
						<div id="nav-wrap">
							<ul class="arrowunderline" id="nav">
								...
								<li class="Actors" id="selected"><a href="Actors.cfm">Actors</a></li>
			       ...
			       <div class="table-title">
						<div class="row">
							...
							<div class="col-sm-6">
								...
								<p><h2>Oyuncular ve <b>Ozellikleri</b></h2></p>
									<table class="table">
  									  <thead>
      									  <tr>
        							  		<th>
											<a href="oyuncu_add.cfm" ><h3>Oyuncu_Ekle</h3></a> 
											</th>
       								  		<th>
										     <a href="oyuncu_upd.cfm" ><h3>Oyuncu_Guncelle</h3></a>
											</th>        											  
											<th>
										     <a href="oyuncu_delete.cfm" ><h3>Oyuncu_Delete</h3></a>
											</th>        											  
     								  ...
     								  <cfoutput query="Oyuncudata">
            							<tr>
										  ...
										  <td>#FilmAdi#</td> 
               							 ...
               							 <td>
                    						<a href="/Books.cfm?fuseaction=book&event=upd&id=#Id#"><i class="fa fa-pencil"></i></a>
                						</td>
            							</tr>
        							  </cfoutput>
    	     						</tbody>
